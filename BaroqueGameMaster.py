...
#TURN_LIMIT = 20 # Terminates runaway games.
if len(sys.argv) > 1:
    import importlib    
    ...
    #import mmb36_Baroque_Agent as player1
    #import agent3 as player1
    #import agent3 as player2
    import Lowply_BC_player as player1
    import PlayerSkeletonB as player2
    #import PlayerSkeletonB as player2
    #import mmb36_Baroque_Agent as player2
    #import mmb36_agent_2 as player1
    #import mmb36_agent_2 as player2
